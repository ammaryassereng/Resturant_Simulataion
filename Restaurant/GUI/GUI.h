...
public:
	...
	//Prints a given message followed by Cook &  Order Count of each type
	void PrintMessage(string TS, int wN, int wG, int wV, int acN, int acG, int acV, int soN, int soG, int soV, Queue<Cook*> &c) const;
	void PrintMessage(string TS, int wN, int wG, int wV, int acN, int acG, int acV, int soN, int soG, int soV) const;
